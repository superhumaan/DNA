...
| **Cursor workbench** | `dna init` / `dna doctor` | 103 prompt stem packs + `/dna-*` commands — DNA always on; `AGENTS.md` routes engineering work through the 9-role agent loop |
...
- **103 stem packs** + **`/dna-*` slash commands** (guidelines, expectations, workflows; includes strategy ladder)
