...
| **DNA Lab** | `dna lab serve` / `/labs` | Local open access; production auth via `dna register lab`; Humaan UI parity (v0.6.7); CI billing banner (v0.6.8). After npm upgrade, **restart the API**. |
