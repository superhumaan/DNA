# DNA Command: Docker Build

> Slash: `/dna-docker-build` · Category: **Delivery**
...
Confirm image built successfully or diagnose Dockerfile/build errors.
...
**Then:** Confirm image built successfully or diagnose Dockerfile/build errors.
