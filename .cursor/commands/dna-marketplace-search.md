# DNA Command: Marketplace Search

> Slash: `/dna-marketplace-search` · Category: **Marketplace**
...
```bash
npx dna marketplace search "$ARGUMENTS"
```
