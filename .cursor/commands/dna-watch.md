# DNA Command: DNA Watch

> Slash: `/dna-watch` · Category: **Core**
...
Explain what regions will update and when to use watch vs manual memory sync.
...
**Then:** Explain what regions will update and when to use watch vs manual memory sync.
