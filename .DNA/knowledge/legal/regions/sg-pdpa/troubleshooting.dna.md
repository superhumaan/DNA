# Troubleshooting — Singapore PDPA

## Top failure modes
1. Singapore PDPA misconfiguration across environments
2. Dependency outage affecting Singapore PDPA
3. Missing monitoring on Singapore PDPA critical path
