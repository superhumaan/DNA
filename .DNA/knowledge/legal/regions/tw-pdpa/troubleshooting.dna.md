# Troubleshooting — Taiwan PDPA

## Top failure modes
1. Taiwan PDPA misconfiguration across environments
2. Dependency outage affecting Taiwan PDPA
3. Missing monitoring on Taiwan PDPA critical path
