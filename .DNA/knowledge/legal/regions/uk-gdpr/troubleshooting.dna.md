# Troubleshooting — UK GDPR

## Top failure modes
1. UK GDPR misconfiguration across environments
2. Dependency outage affecting UK GDPR
3. Missing monitoring on UK GDPR critical path
