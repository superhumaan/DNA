# Troubleshooting — India DPDP

## Top failure modes
1. India DPDP misconfiguration across environments
2. Dependency outage affecting India DPDP
3. Missing monitoring on India DPDP critical path
