# Troubleshooting — Japan APPI

## Top failure modes
1. Japan APPI misconfiguration across environments
2. Dependency outage affecting Japan APPI
3. Missing monitoring on Japan APPI critical path
