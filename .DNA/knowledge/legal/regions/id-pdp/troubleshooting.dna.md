# Troubleshooting — Indonesia PDP

## Top failure modes
1. Indonesia PDP misconfiguration across environments
2. Dependency outage affecting Indonesia PDP
3. Missing monitoring on Indonesia PDP critical path
