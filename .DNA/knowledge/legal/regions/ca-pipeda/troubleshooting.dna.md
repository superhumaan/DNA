# Troubleshooting — Canada PIPEDA

## Top failure modes
1. Canada PIPEDA misconfiguration across environments
2. Dependency outage affecting Canada PIPEDA
3. Missing monitoring on Canada PIPEDA critical path
