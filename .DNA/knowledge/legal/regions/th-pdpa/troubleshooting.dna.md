# Troubleshooting — Thailand PDPA

## Top failure modes
1. Thailand PDPA misconfiguration across environments
2. Dependency outage affecting Thailand PDPA
3. Missing monitoring on Thailand PDPA critical path
