# Troubleshooting — Hong Kong PDPO

## Top failure modes
1. Hong Kong PDPO misconfiguration across environments
2. Dependency outage affecting Hong Kong PDPO
3. Missing monitoring on Hong Kong PDPO critical path
