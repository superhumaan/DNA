# Troubleshooting — Philippines DPA

## Top failure modes
1. Philippines DPA misconfiguration across environments
2. Dependency outage affecting Philippines DPA
3. Missing monitoring on Philippines DPA critical path
