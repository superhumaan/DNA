# Troubleshooting — Vietnam PDPD

## Top failure modes
1. Vietnam PDPD misconfiguration across environments
2. Dependency outage affecting Vietnam PDPD
3. Missing monitoring on Vietnam PDPD critical path
