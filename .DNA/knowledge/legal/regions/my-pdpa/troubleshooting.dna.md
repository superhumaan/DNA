# Troubleshooting — Malaysia PDPA

## Top failure modes
1. Malaysia PDPA misconfiguration across environments
2. Dependency outage affecting Malaysia PDPA
3. Missing monitoring on Malaysia PDPA critical path
