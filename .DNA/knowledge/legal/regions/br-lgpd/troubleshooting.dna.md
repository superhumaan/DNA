# Troubleshooting — Brazil LGPD

## Top failure modes
1. Brazil LGPD misconfiguration across environments
2. Dependency outage affecting Brazil LGPD
3. Missing monitoring on Brazil LGPD critical path
