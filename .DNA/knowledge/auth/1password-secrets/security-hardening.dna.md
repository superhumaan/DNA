# Security hardening — 1Password Secrets Automation

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **1Password Secrets Automation**.
