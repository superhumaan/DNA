# Security hardening — FIDO & Hardware Keys

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **FIDO & Hardware Keys**.
