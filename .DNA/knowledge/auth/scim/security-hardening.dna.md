# Security hardening — SCIM Provisioning

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **SCIM Provisioning**.
