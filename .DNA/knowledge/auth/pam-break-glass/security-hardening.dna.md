# Security hardening — PAM & Break-Glass Access

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **PAM & Break-Glass Access**.
