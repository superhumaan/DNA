# Security hardening — Azure Communication Services

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Azure Communication Services**.
