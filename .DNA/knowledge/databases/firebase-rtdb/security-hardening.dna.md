# Security hardening — Firebase Realtime DB

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Firebase Realtime DB**.
