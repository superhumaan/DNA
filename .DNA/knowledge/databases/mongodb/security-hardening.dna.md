# Security hardening — MongoDB

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **MongoDB**.

## Controls
- SCRAM auth
- Network isolation
- Field-level encryption when needed
