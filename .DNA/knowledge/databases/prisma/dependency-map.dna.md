# Dependency map — Prisma

## Upstream
List services **Prisma** calls (DB, auth, payments, AI, queues). Note timeout and retry policy per dependency.

## Downstream
Who breaks if **Prisma** is down? (UI routes, jobs, webhooks, partner APIs)
