# Security hardening — Prisma

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Prisma**.

## Controls
- Parameterized queries (default)
- No raw SQL with string concat
