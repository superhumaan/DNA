# Security hardening — WebSockets Patterns

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **WebSockets Patterns**.
