# Troubleshooting — Chinese (Traditional)

## Top failure modes
1. Chinese (Traditional) misconfiguration across environments
2. Dependency outage affecting Chinese (Traditional)
3. Missing monitoring on Chinese (Traditional) critical path
