# Troubleshooting — Indonesian

## Top failure modes
1. Indonesian misconfiguration across environments
2. Dependency outage affecting Indonesian
3. Missing monitoring on Indonesian critical path
