# Troubleshooting — Portuguese

## Top failure modes
1. Portuguese misconfiguration across environments
2. Dependency outage affecting Portuguese
3. Missing monitoring on Portuguese critical path
