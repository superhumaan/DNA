# Troubleshooting — Chinese (Simplified)

## Top failure modes
1. Chinese (Simplified) misconfiguration across environments
2. Dependency outage affecting Chinese (Simplified)
3. Missing monitoring on Chinese (Simplified) critical path
