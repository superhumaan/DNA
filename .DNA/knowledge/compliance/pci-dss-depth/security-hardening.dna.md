# Security hardening — PCI DSS Depth

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **PCI DSS Depth**.

## Controls
- No CVV storage
- TLS everywhere
- Least privilege to payment admin
