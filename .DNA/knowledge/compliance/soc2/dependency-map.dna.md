# Dependency map — SOC 2

## Upstream
List services **SOC 2** calls (DB, auth, payments, AI, queues). Note timeout and retry policy per dependency.

## Downstream
Who breaks if **SOC 2** is down? (UI routes, jobs, webhooks, partner APIs)
