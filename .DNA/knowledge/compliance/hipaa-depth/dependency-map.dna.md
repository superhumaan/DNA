# Dependency map — HIPAA Depth

## Upstream
List services **HIPAA Depth** calls (DB, auth, payments, AI, queues). Note timeout and retry policy per dependency.

## Downstream
Who breaks if **HIPAA Depth** is down? (UI routes, jobs, webhooks, partner APIs)
