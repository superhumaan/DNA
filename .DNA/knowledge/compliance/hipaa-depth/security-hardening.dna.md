# Security hardening — HIPAA Depth

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **HIPAA Depth**.

## Controls
- Encrypt PHI
- Unique user IDs
- Auto logoff / session controls
