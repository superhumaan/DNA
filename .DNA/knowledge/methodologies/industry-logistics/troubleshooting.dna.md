# Troubleshooting — Logistics Delivery

## Top failure modes
1. Logistics Delivery misconfiguration across environments
2. Dependency outage affecting Logistics Delivery
3. Missing monitoring on Logistics Delivery critical path
