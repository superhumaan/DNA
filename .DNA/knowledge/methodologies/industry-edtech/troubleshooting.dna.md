# Troubleshooting — EdTech Delivery

## Top failure modes
1. EdTech Delivery misconfiguration across environments
2. Dependency outage affecting EdTech Delivery
3. Missing monitoring on EdTech Delivery critical path
