# Security hardening — SRE

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **SRE**.

## Controls
- Least privilege for SRE
- Secrets never in git
- Validate inputs at SRE boundaries
