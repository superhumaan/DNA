# Troubleshooting — Gaming Delivery

## Top failure modes
1. Gaming Delivery misconfiguration across environments
2. Dependency outage affecting Gaming Delivery
3. Missing monitoring on Gaming Delivery critical path
