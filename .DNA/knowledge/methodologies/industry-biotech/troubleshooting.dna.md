# Troubleshooting — Biotech Delivery

## Top failure modes
1. Biotech Delivery misconfiguration across environments
2. Dependency outage affecting Biotech Delivery
3. Missing monitoring on Biotech Delivery critical path
