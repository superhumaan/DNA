# Troubleshooting — InsurTech Delivery

## Top failure modes
1. InsurTech Delivery misconfiguration across environments
2. Dependency outage affecting InsurTech Delivery
3. Missing monitoring on InsurTech Delivery critical path
