# Troubleshooting — Legal Tech Delivery

## Top failure modes
1. Legal Tech Delivery misconfiguration across environments
2. Dependency outage affecting Legal Tech Delivery
3. Missing monitoring on Legal Tech Delivery critical path
