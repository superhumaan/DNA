# Troubleshooting — Scrum at Scale

## Top failure modes
1. Scrum at Scale misconfiguration across environments
2. Dependency outage affecting Scrum at Scale
3. Missing monitoring on Scrum at Scale critical path
