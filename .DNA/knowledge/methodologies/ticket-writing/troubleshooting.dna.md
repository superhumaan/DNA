# Troubleshooting — Ticket Writing

## Top failure modes
1. Ticket Writing misconfiguration across environments
2. Dependency outage affecting Ticket Writing
3. Missing monitoring on Ticket Writing critical path
