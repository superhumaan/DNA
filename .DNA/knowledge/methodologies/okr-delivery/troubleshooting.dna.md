# Troubleshooting — OKRs for Delivery

## Top failure modes
1. OKRs for Delivery misconfiguration across environments
2. Dependency outage affecting OKRs for Delivery
3. Missing monitoring on OKRs for Delivery critical path
