# Troubleshooting — HR Tech Delivery

## Top failure modes
1. HR Tech Delivery misconfiguration across environments
2. Dependency outage affecting HR Tech Delivery
3. Missing monitoring on HR Tech Delivery critical path
