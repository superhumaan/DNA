# Troubleshooting — Scrum of Scrums

## Top failure modes
1. Scrum of Scrums misconfiguration across environments
2. Dependency outage affecting Scrum of Scrums
3. Missing monitoring on Scrum of Scrums critical path
