# Troubleshooting — LeSS Huge

## Top failure modes
1. LeSS Huge misconfiguration across environments
2. Dependency outage affecting LeSS Huge
3. Missing monitoring on LeSS Huge critical path
