# Troubleshooting — Healthcare Delivery

## Top failure modes
1. Healthcare Delivery misconfiguration across environments
2. Dependency outage affecting Healthcare Delivery
3. Missing monitoring on Healthcare Delivery critical path
