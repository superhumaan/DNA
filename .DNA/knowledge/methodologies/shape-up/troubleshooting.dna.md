# Troubleshooting — Shape Up

## Top failure modes
1. Shape Up misconfiguration across environments
2. Dependency outage affecting Shape Up
3. Missing monitoring on Shape Up critical path
