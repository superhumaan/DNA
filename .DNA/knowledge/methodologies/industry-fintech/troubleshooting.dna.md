# Troubleshooting — Fintech Delivery

## Top failure modes
1. Fintech Delivery misconfiguration across environments
2. Dependency outage affecting Fintech Delivery
3. Missing monitoring on Fintech Delivery critical path
