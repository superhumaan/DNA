# Troubleshooting — Definition of Done

## Top failure modes
1. Definition of Done misconfiguration across environments
2. Dependency outage affecting Definition of Done
3. Missing monitoring on Definition of Done critical path
