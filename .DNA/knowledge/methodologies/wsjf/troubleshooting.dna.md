# Troubleshooting — WSJF Prioritisation

## Top failure modes
1. WSJF Prioritisation misconfiguration across environments
2. Dependency outage affecting WSJF Prioritisation
3. Missing monitoring on WSJF Prioritisation critical path
