# Troubleshooting — MarTech Delivery

## Top failure modes
1. MarTech Delivery misconfiguration across environments
2. Dependency outage affecting MarTech Delivery
3. Missing monitoring on MarTech Delivery critical path
