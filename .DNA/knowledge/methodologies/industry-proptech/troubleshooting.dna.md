# Troubleshooting — PropTech Delivery

## Top failure modes
1. PropTech Delivery misconfiguration across environments
2. Dependency outage affecting PropTech Delivery
3. Missing monitoring on PropTech Delivery critical path
