# Troubleshooting — Dual-track Agile

## Top failure modes
1. Dual-track Agile misconfiguration across environments
2. Dependency outage affecting Dual-track Agile
3. Missing monitoring on Dual-track Agile critical path
