# Troubleshooting — Design Ops

## Top failure modes
1. Design Ops misconfiguration across environments
2. Dependency outage affecting Design Ops
3. Missing monitoring on Design Ops critical path
