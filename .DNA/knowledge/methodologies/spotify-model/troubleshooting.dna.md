# Troubleshooting — Spotify Model

## Top failure modes
1. Spotify Model misconfiguration across environments
2. Dependency outage affecting Spotify Model
3. Missing monitoring on Spotify Model critical path
