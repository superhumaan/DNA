# Troubleshooting — DNA Feature Factory

## Top failure modes
1. DNA Feature Factory misconfiguration across environments
2. Dependency outage affecting DNA Feature Factory
3. Missing monitoring on DNA Feature Factory critical path
