# Troubleshooting — Telecom Delivery

## Top failure modes
1. Telecom Delivery misconfiguration across environments
2. Dependency outage affecting Telecom Delivery
3. Missing monitoring on Telecom Delivery critical path
