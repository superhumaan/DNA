# Troubleshooting — AgriTech Delivery

## Top failure modes
1. AgriTech Delivery misconfiguration across environments
2. Dependency outage affecting AgriTech Delivery
3. Missing monitoring on AgriTech Delivery critical path
