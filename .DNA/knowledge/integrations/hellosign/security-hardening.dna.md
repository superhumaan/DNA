# Security hardening — Dropbox Sign (HelloSign)

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Dropbox Sign (HelloSign)**.
