# Security hardening — Google Analytics 4

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Google Analytics 4**.
