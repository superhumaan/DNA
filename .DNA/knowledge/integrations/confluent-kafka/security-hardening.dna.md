# Security hardening — Confluent Kafka Connect

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Confluent Kafka Connect**.
