# Security hardening — Serverless Framework

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Serverless Framework**.
