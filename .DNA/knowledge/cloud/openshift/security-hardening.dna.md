# Security hardening — Red Hat OpenShift

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Red Hat OpenShift**.
