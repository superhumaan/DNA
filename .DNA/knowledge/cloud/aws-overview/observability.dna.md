# Observability — AWS Overview

## Golden signals
- AWS Overview error rate
- AWS Overview latency p95
- AWS Overview saturation
...
## Dashboards
One “AWS Overview health” board: traffic, errors, latency, dependency status. Link from runbook.
