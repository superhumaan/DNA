# Security hardening — Firebase Platform

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Firebase Platform**.
