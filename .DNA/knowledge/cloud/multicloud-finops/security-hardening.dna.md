# Security hardening — Multi-Cloud & FinOps

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Multi-Cloud & FinOps**.
