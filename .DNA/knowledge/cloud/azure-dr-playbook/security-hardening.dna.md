# Security hardening — Azure Disaster Recovery

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Azure Disaster Recovery**.
