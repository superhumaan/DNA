# Security hardening — Google Cloud Pub/Sub

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Google Cloud Pub/Sub**.
