# Security hardening — Oracle Cloud Infrastructure

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Oracle Cloud Infrastructure**.
