# Security hardening — Cloudflare Workers

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Cloudflare Workers**.
