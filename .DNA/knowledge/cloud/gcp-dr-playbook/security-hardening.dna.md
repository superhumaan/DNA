# Security hardening — GCP Disaster Recovery

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **GCP Disaster Recovery**.
