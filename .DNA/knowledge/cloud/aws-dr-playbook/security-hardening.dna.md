# Security hardening — AWS Disaster Recovery

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **AWS Disaster Recovery**.
