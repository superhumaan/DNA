# Security hardening — Bitbucket Pipelines

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Bitbucket Pipelines**.
