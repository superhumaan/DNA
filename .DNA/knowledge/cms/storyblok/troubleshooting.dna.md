# Troubleshooting — Storyblok

## Top failure modes
1. Storyblok misconfiguration across environments
2. Dependency outage affecting Storyblok
3. Missing monitoring on Storyblok critical path
