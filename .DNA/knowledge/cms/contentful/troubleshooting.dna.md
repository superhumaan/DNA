# Troubleshooting — Contentful

## Top failure modes
1. Contentful misconfiguration across environments
2. Dependency outage affecting Contentful
3. Missing monitoring on Contentful critical path
