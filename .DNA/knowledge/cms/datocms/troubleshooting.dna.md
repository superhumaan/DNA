# Troubleshooting — DatoCMS

## Top failure modes
1. DatoCMS misconfiguration across environments
2. Dependency outage affecting DatoCMS
3. Missing monitoring on DatoCMS critical path
