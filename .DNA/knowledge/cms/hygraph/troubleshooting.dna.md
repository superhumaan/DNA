# Troubleshooting — Hygraph

## Top failure modes
1. Hygraph misconfiguration across environments
2. Dependency outage affecting Hygraph
3. Missing monitoring on Hygraph critical path
