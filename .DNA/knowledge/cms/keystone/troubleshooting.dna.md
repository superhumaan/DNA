# Troubleshooting — KeystoneJS

## Top failure modes
1. KeystoneJS misconfiguration across environments
2. Dependency outage affecting KeystoneJS
3. Missing monitoring on KeystoneJS critical path
