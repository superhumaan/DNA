# Troubleshooting — Directus

## Top failure modes
1. Directus misconfiguration across environments
2. Dependency outage affecting Directus
3. Missing monitoring on Directus critical path
