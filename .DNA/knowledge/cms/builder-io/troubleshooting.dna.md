# Troubleshooting — Builder.io

## Top failure modes
1. Builder.io misconfiguration across environments
2. Dependency outage affecting Builder.io
3. Missing monitoring on Builder.io critical path
