# Troubleshooting — Ghost (CMS)

## Top failure modes
1. Ghost (CMS) misconfiguration across environments
2. Dependency outage affecting Ghost (CMS)
3. Missing monitoring on Ghost (CMS) critical path
