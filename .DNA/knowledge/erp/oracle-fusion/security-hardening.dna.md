# Security hardening — Oracle Fusion Cloud

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Oracle Fusion Cloud**.
