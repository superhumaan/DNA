# Security hardening — Adobe Experience Cloud

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Adobe Experience Cloud**.
