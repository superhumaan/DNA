# Troubleshooting — Mobile UI

## Top failure modes
1. Mobile UI misconfiguration across environments
2. Dependency outage affecting Mobile UI
3. Missing monitoring on Mobile UI critical path
