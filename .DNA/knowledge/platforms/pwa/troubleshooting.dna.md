# Troubleshooting — Progressive Web App

## Top failure modes
1. Progressive Web App misconfiguration across environments
2. Dependency outage affecting Progressive Web App
3. Missing monitoring on Progressive Web App critical path
