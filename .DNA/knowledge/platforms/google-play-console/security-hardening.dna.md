# Security hardening — Google Play Console

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Google Play Console**.
