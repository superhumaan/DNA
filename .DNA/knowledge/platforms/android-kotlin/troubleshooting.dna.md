# Troubleshooting — Android (Kotlin)

## Top failure modes
1. Android (Kotlin) misconfiguration across environments
2. Dependency outage affecting Android (Kotlin)
3. Missing monitoring on Android (Kotlin) critical path
