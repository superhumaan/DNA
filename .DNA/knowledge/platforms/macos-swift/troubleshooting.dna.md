# Troubleshooting — macOS (Swift)

## Top failure modes
1. macOS (Swift) misconfiguration across environments
2. Dependency outage affecting macOS (Swift)
3. Missing monitoring on macOS (Swift) critical path
