# Troubleshooting — iOS (Swift)

## Top failure modes
1. iOS (Swift) misconfiguration across environments
2. Dependency outage affecting iOS (Swift)
3. Missing monitoring on iOS (Swift) critical path
