# Security hardening — App Store Connect

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **App Store Connect**.
