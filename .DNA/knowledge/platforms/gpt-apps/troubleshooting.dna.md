# Troubleshooting — GPT Apps & Actions

## Top failure modes
1. GPT Apps & Actions misconfiguration across environments
2. Dependency outage affecting GPT Apps & Actions
3. Missing monitoring on GPT Apps & Actions critical path
