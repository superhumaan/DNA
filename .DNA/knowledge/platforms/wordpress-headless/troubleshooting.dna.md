# Troubleshooting — WordPress Headless

## Top failure modes
1. WordPress Headless misconfiguration across environments
2. Dependency outage affecting WordPress Headless
3. Missing monitoring on WordPress Headless critical path
