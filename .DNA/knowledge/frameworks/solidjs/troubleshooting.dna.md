# Troubleshooting — SolidJS

## Top failure modes
1. SolidJS misconfiguration across environments
2. Dependency outage affecting SolidJS
3. Missing monitoring on SolidJS critical path
