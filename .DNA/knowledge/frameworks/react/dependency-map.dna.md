# Dependency map — React

## Upstream
List services **React** calls (DB, auth, payments, AI, queues). Note timeout and retry policy per dependency.

## Downstream
Who breaks if **React** is down? (UI routes, jobs, webhooks, partner APIs)
