# Dependency map — Next.js

## Upstream
List services **Next.js** calls (DB, auth, payments, AI, queues). Note timeout and retry policy per dependency.

## Downstream
Who breaks if **Next.js** is down? (UI routes, jobs, webhooks, partner APIs)
