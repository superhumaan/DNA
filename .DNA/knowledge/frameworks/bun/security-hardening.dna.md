# Security hardening — Bun

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Bun**.

## Controls
- Least privilege for Bun
- Secrets never in git
- Validate inputs at Bun boundaries
