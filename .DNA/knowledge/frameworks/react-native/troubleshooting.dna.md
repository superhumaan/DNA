# Troubleshooting — React Native / Expo

## Top failure modes
1. React Native / Expo misconfiguration across environments
2. Dependency outage affecting React Native / Expo
3. Missing monitoring on React Native / Expo critical path
