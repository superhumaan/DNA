# Troubleshooting — GoCardless

## Top failure modes
1. GoCardless misconfiguration across environments
2. Dependency outage affecting GoCardless
3. Missing monitoring on GoCardless critical path
