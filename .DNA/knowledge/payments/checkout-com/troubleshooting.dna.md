# Troubleshooting — Checkout.com

## Top failure modes
1. Checkout.com misconfiguration across environments
2. Dependency outage affecting Checkout.com
3. Missing monitoring on Checkout.com critical path
