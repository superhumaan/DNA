# Troubleshooting — Payments Overview

## Top failure modes
1. Payments Overview misconfiguration between environments
2. Dependency outage affecting Payments Overview
3. Silent permission or schema drift
