# Security hardening — Coinbase Commerce

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Coinbase Commerce**.
