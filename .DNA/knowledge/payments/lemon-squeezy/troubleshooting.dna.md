# Troubleshooting — Lemon Squeezy

## Top failure modes
1. Lemon Squeezy misconfiguration across environments
2. Dependency outage affecting Lemon Squeezy
3. Missing monitoring on Lemon Squeezy critical path
