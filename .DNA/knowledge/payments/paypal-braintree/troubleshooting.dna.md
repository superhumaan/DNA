# Troubleshooting — PayPal & Braintree

## Top failure modes
1. PayPal & Braintree misconfiguration across environments
2. Dependency outage affecting PayPal & Braintree
3. Missing monitoring on PayPal & Braintree critical path
