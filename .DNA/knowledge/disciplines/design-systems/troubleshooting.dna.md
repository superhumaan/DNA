# Troubleshooting — Design Systems

## Top failure modes
1. Design Systems misconfiguration across environments
2. Dependency outage affecting Design Systems
3. Missing monitoring on Design Systems critical path
