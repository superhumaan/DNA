# Troubleshooting — TDD & BDD

## Top failure modes
1. TDD & BDD misconfiguration across environments
2. Dependency outage affecting TDD & BDD
3. Missing monitoring on TDD & BDD critical path
