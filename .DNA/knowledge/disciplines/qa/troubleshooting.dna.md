# Troubleshooting — QA Discipline

## Top failure modes
1. QA Discipline misconfiguration across environments
2. Dependency outage affecting QA Discipline
3. Missing monitoring on QA Discipline critical path
