# Troubleshooting — Monorepo Practices

## Top failure modes
1. Monorepo Practices misconfiguration across environments
2. Dependency outage affecting Monorepo Practices
3. Missing monitoring on Monorepo Practices critical path
