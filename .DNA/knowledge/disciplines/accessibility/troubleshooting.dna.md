# Troubleshooting — Accessibility (a11y)

## Top failure modes
1. Accessibility (a11y) misconfiguration across environments
2. Dependency outage affecting Accessibility (a11y)
3. Missing monitoring on Accessibility (a11y) critical path
