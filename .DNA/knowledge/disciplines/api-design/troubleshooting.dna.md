# Troubleshooting — API Design

## Top failure modes
1. API Design misconfiguration across environments
2. Dependency outage affecting API Design
3. Missing monitoring on API Design critical path
