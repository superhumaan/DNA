# Security hardening — MOOC Platform Patterns

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **MOOC Platform Patterns**.
