# Troubleshooting — Hypergrowth / Unicorn

## Top failure modes
1. Hypergrowth / Unicorn misconfiguration across environments
2. Dependency outage affecting Hypergrowth / Unicorn
3. Missing monitoring on Hypergrowth / Unicorn critical path
