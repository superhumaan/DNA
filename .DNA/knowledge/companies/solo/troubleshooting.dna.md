# Troubleshooting — Solo / Indie

## Top failure modes
1. Solo / Indie misconfiguration across environments
2. Dependency outage affecting Solo / Indie
3. Missing monitoring on Solo / Indie critical path
