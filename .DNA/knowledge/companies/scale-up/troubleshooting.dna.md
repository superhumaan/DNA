# Troubleshooting — Scale-up

## Top failure modes
1. Scale-up misconfiguration across environments
2. Dependency outage affecting Scale-up
3. Missing monitoring on Scale-up critical path
