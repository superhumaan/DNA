# Security hardening — SME

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **SME**.

## Controls
- Least privilege for SME
- Secrets never in git
- Validate inputs at SME boundaries
