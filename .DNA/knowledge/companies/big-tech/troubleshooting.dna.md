# Troubleshooting — Big Tech

## Top failure modes
1. Big Tech misconfiguration across environments
2. Dependency outage affecting Big Tech
3. Missing monitoring on Big Tech critical path
