# Troubleshooting — Nonprofit / NGO

## Top failure modes
1. Nonprofit / NGO misconfiguration across environments
2. Dependency outage affecting Nonprofit / NGO
3. Missing monitoring on Nonprofit / NGO critical path
