# Troubleshooting — Travel Scale-up

## Top failure modes
1. Travel Scale-up misconfiguration across environments
2. Dependency outage affecting Travel Scale-up
3. Missing monitoring on Travel Scale-up critical path
