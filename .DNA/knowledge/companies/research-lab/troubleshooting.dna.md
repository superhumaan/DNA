# Troubleshooting — Research Lab

## Top failure modes
1. Research Lab misconfiguration across environments
2. Dependency outage affecting Research Lab
3. Missing monitoring on Research Lab critical path
