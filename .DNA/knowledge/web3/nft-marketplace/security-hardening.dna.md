# Security hardening — NFT Marketplace Patterns

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **NFT Marketplace Patterns**.
