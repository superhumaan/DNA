# Security hardening — Smart Contract Security

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Smart Contract Security**.
