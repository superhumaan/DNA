# Security hardening — React Server Components

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **React Server Components**.
