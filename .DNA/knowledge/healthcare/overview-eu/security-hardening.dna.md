# Security hardening — Healthcare Overview — European Union

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Healthcare Overview — European Union**.
