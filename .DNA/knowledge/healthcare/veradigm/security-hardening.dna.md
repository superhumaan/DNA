# Security hardening — Veradigm (Allscripts)

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Veradigm (Allscripts)**.
