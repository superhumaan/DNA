# Security hardening — Healthcare Overview — Cambodia

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Healthcare Overview — Cambodia**.
