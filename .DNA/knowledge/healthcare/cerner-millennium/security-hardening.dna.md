# Security hardening — Cerner Millennium Depth

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Cerner Millennium Depth**.
