# Security hardening — PACS & Imaging Workflows

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **PACS & Imaging Workflows**.
