# Security hardening — Healthcare Overview — Asia-Pacific

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Healthcare Overview — Asia-Pacific**.
