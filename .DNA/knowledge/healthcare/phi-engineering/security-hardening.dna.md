# Security hardening — PHI Engineering Patterns

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **PHI Engineering Patterns**.
