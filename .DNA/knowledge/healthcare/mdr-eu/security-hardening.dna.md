# Security hardening — EU MDR (Medical Devices)

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **EU MDR (Medical Devices)**.
