# Security hardening — Oracle Health (Cerner)

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Oracle Health (Cerner)**.
