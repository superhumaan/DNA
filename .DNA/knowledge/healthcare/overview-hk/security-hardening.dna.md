# Security hardening — Healthcare Overview — Hong Kong

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Healthcare Overview — Hong Kong**.
