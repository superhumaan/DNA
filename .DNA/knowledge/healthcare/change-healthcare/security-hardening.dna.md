# Security hardening — Change Healthcare (Optum)

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Change Healthcare (Optum)**.
