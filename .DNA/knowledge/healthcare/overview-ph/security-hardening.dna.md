# Security hardening — Healthcare Overview — Philippines

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Healthcare Overview — Philippines**.
