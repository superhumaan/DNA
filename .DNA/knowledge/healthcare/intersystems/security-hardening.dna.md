# Security hardening — InterSystems HealthShare / IRIS

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **InterSystems HealthShare / IRIS**.
