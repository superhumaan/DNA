# Security hardening — CMS Interoperability Rules

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **CMS Interoperability Rules**.
