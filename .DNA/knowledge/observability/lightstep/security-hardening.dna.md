# Security hardening — ServiceNow Lightstep

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **ServiceNow Lightstep**.
