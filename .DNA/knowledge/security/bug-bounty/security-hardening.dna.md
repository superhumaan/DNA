# Security hardening — Bug Bounty Programs

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Bug Bounty Programs**.
