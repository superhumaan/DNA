# Troubleshooting — RBAC & Zero Trust

## Top failure modes
1. RBAC & Zero Trust misconfiguration across environments
2. Dependency outage affecting RBAC & Zero Trust
3. Missing monitoring on RBAC & Zero Trust critical path
