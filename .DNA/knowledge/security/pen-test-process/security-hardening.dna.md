# Security hardening — Penetration Testing Process

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Penetration Testing Process**.
