# Security hardening — Safari iOS WebKit

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Safari iOS WebKit**.
