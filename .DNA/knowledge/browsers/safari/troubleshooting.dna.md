# Troubleshooting — Apple Safari

## Top failure modes
1. Apple Safari misconfiguration across environments
2. Dependency outage affecting Apple Safari
3. Missing monitoring on Apple Safari critical path
