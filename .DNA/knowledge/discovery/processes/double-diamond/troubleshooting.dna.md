# Troubleshooting — Double Diamond

## Top failure modes
1. Double Diamond misconfiguration across environments
2. Dependency outage affecting Double Diamond
3. Missing monitoring on Double Diamond critical path
