# Troubleshooting — Lean Startup

## Top failure modes
1. Lean Startup misconfiguration across environments
2. Dependency outage affecting Lean Startup
3. Missing monitoring on Lean Startup critical path
