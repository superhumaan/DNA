# Troubleshooting — JTBD Framework

## Top failure modes
1. JTBD Framework misconfiguration across environments
2. Dependency outage affecting JTBD Framework
3. Missing monitoring on JTBD Framework critical path
