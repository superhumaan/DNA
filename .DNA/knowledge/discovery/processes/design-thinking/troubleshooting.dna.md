# Troubleshooting — Design Thinking

## Top failure modes
1. Design Thinking misconfiguration across environments
2. Dependency outage affecting Design Thinking
3. Missing monitoring on Design Thinking critical path
