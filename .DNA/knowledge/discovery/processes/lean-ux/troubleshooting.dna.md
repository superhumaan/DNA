# Troubleshooting — Lean UX

## Top failure modes
1. Lean UX misconfiguration across environments
2. Dependency outage affecting Lean UX
3. Missing monitoring on Lean UX critical path
