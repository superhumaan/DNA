# Observability — Discovery Overview

## Golden signals
- assumptions validated/killed
- time-to-decision
- delivery rework from bad discovery
...
## Dashboards
One “Discovery Overview health” board: traffic, errors, latency, dependency status. Link from runbook.
