# Troubleshooting — Handoff to Delivery

## Top failure modes
1. Handoff to Delivery misconfiguration across environments
2. Dependency outage affecting Handoff to Delivery
3. Missing monitoring on Handoff to Delivery critical path
