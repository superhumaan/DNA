# Troubleshooting — Research Readout

## Top failure modes
1. Research Readout misconfiguration across environments
2. Dependency outage affecting Research Readout
3. Missing monitoring on Research Readout critical path
