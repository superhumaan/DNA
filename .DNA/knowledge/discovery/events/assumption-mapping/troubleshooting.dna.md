# Troubleshooting — Assumption Mapping

## Top failure modes
1. Assumption Mapping misconfiguration across environments
2. Dependency outage affecting Assumption Mapping
3. Missing monitoring on Assumption Mapping critical path
