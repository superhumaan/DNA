# Troubleshooting — Pivot Review

## Top failure modes
1. Pivot Review misconfiguration across environments
2. Dependency outage affecting Pivot Review
3. Missing monitoring on Pivot Review critical path
