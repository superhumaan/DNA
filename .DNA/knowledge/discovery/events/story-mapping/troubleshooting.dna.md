# Troubleshooting — Story Mapping

## Top failure modes
1. Story Mapping misconfiguration across environments
2. Dependency outage affecting Story Mapping
3. Missing monitoring on Story Mapping critical path
