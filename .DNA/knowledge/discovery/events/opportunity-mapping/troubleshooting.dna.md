# Troubleshooting — Opportunity Mapping

## Top failure modes
1. Opportunity Mapping misconfiguration across environments
2. Dependency outage affecting Opportunity Mapping
3. Missing monitoring on Opportunity Mapping critical path
