# Troubleshooting — Kickoff Workshop

## Top failure modes
1. Kickoff Workshop misconfiguration across environments
2. Dependency outage affecting Kickoff Workshop
3. Missing monitoring on Kickoff Workshop critical path
