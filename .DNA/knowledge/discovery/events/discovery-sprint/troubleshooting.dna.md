# Troubleshooting — Discovery Sprint

## Top failure modes
1. Discovery Sprint misconfiguration across environments
2. Dependency outage affecting Discovery Sprint
3. Missing monitoring on Discovery Sprint critical path
