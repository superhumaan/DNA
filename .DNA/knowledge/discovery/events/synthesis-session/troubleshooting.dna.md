# Troubleshooting — Synthesis Session

## Top failure modes
1. Synthesis Session misconfiguration across environments
2. Dependency outage affecting Synthesis Session
3. Missing monitoring on Synthesis Session critical path
