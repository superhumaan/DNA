# Troubleshooting — Design Sprint

## Top failure modes
1. Design Sprint misconfiguration across environments
2. Dependency outage affecting Design Sprint
3. Missing monitoring on Design Sprint critical path
