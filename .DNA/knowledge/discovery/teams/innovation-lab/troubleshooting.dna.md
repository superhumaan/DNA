# Troubleshooting — Innovation Lab

## Top failure modes
1. Innovation Lab misconfiguration across environments
2. Dependency outage affecting Innovation Lab
3. Missing monitoring on Innovation Lab critical path
