# Troubleshooting — Embedded Triad

## Top failure modes
1. Embedded Triad misconfiguration across environments
2. Dependency outage affecting Embedded Triad
3. Missing monitoring on Embedded Triad critical path
