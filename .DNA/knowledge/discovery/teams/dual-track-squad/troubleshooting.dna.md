# Troubleshooting — Dual-Track Squad

## Top failure modes
1. Dual-Track Squad misconfiguration across environments
2. Dependency outage affecting Dual-Track Squad
3. Missing monitoring on Dual-Track Squad critical path
