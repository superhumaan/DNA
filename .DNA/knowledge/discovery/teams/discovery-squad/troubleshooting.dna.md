# Troubleshooting — Discovery Squad

## Top failure modes
1. Discovery Squad misconfiguration across environments
2. Dependency outage affecting Discovery Squad
3. Missing monitoring on Discovery Squad critical path
