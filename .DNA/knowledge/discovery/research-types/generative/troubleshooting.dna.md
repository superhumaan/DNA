# Troubleshooting — Generative Research

## Top failure modes
1. Generative Research misconfiguration across environments
2. Dependency outage affecting Generative Research
3. Missing monitoring on Generative Research critical path
