# Troubleshooting — Mixed Methods

## Top failure modes
1. Mixed Methods misconfiguration across environments
2. Dependency outage affecting Mixed Methods
3. Missing monitoring on Mixed Methods critical path
