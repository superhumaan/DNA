# Troubleshooting — Evaluative Research

## Top failure modes
1. Evaluative Research misconfiguration across environments
2. Dependency outage affecting Evaluative Research
3. Missing monitoring on Evaluative Research critical path
