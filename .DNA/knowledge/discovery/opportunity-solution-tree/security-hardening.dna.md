# Security hardening — Opportunity Solution Tree

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Opportunity Solution Tree**.

## Controls
- No customer PII on public boards
