# Troubleshooting — Ethnography

## Top failure modes
1. Ethnography misconfiguration across environments
2. Dependency outage affecting Ethnography
3. Missing monitoring on Ethnography critical path
