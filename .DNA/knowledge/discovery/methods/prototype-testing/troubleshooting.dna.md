# Troubleshooting — Prototype Testing

## Top failure modes
1. Prototype Testing misconfiguration across environments
2. Dependency outage affecting Prototype Testing
3. Missing monitoring on Prototype Testing critical path
