# Troubleshooting — JTBD Interviews

## Top failure modes
1. JTBD Interviews misconfiguration across environments
2. Dependency outage affecting JTBD Interviews
3. Missing monitoring on JTBD Interviews critical path
