# Troubleshooting — Pricing Research

## Top failure modes
1. Pricing Research misconfiguration across environments
2. Dependency outage affecting Pricing Research
3. Missing monitoring on Pricing Research critical path
