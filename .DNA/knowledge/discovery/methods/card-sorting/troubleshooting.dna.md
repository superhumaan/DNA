# Troubleshooting — Card Sorting

## Top failure modes
1. Card Sorting misconfiguration across environments
2. Dependency outage affecting Card Sorting
3. Missing monitoring on Card Sorting critical path
