# Troubleshooting — Contextual Inquiry

## Top failure modes
1. Contextual Inquiry misconfiguration across environments
2. Dependency outage affecting Contextual Inquiry
3. Missing monitoring on Contextual Inquiry critical path
