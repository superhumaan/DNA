# Troubleshooting — Tree Testing

## Top failure modes
1. Tree Testing misconfiguration across environments
2. Dependency outage affecting Tree Testing
3. Missing monitoring on Tree Testing critical path
