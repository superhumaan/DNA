# Troubleshooting — PMF Stage

## Top failure modes
1. PMF Stage misconfiguration across environments
2. Dependency outage affecting PMF Stage
3. Missing monitoring on PMF Stage critical path
