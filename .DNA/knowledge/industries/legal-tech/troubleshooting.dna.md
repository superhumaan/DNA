# Troubleshooting — Legal Tech

## Top failure modes
1. Legal Tech misconfiguration across environments
2. Dependency outage affecting Legal Tech
3. Missing monitoring on Legal Tech critical path
