# Troubleshooting — AgriTech

## Top failure modes
1. AgriTech misconfiguration across environments
2. Dependency outage affecting AgriTech
3. Missing monitoring on AgriTech critical path
