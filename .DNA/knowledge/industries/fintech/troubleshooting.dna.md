# Troubleshooting — Fintech & Banking

## Top failure modes
1. Fintech & Banking misconfiguration across environments
2. Dependency outage affecting Fintech & Banking
3. Missing monitoring on Fintech & Banking critical path
