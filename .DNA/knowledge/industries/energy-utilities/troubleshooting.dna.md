# Troubleshooting — Energy & Utilities

## Top failure modes
1. Energy & Utilities misconfiguration across environments
2. Dependency outage affecting Energy & Utilities
3. Missing monitoring on Energy & Utilities critical path
