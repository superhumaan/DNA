# Troubleshooting — Media & Entertainment

## Top failure modes
1. Media & Entertainment misconfiguration across environments
2. Dependency outage affecting Media & Entertainment
3. Missing monitoring on Media & Entertainment critical path
