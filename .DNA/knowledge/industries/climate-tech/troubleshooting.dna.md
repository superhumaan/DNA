# Troubleshooting — Climate Tech

## Top failure modes
1. Climate Tech misconfiguration across environments
2. Dependency outage affecting Climate Tech
3. Missing monitoring on Climate Tech critical path
