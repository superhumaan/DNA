# Troubleshooting — Crypto & Web3

## Top failure modes
1. Crypto & Web3 misconfiguration across environments
2. Dependency outage affecting Crypto & Web3
3. Missing monitoring on Crypto & Web3 critical path
