# Troubleshooting — MarTech & AdTech

## Top failure modes
1. MarTech & AdTech misconfiguration across environments
2. Dependency outage affecting MarTech & AdTech
3. Missing monitoring on MarTech & AdTech critical path
