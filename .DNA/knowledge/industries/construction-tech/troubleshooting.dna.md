# Troubleshooting — Construction Tech

## Top failure modes
1. Construction Tech misconfiguration across environments
2. Dependency outage affecting Construction Tech
3. Missing monitoring on Construction Tech critical path
