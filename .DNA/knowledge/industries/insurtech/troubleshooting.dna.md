# Troubleshooting — InsurTech

## Top failure modes
1. InsurTech misconfiguration across environments
2. Dependency outage affecting InsurTech
3. Missing monitoring on InsurTech critical path
