# Troubleshooting — Healthcare

## Top failure modes
1. Healthcare misconfiguration across environments
2. Dependency outage affecting Healthcare
3. Missing monitoring on Healthcare critical path
