# Troubleshooting — Automotive & Mobility

## Top failure modes
1. Automotive & Mobility misconfiguration across environments
2. Dependency outage affecting Automotive & Mobility
3. Missing monitoring on Automotive & Mobility critical path
