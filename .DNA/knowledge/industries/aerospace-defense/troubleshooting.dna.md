# Troubleshooting — Aerospace & Defense

## Top failure modes
1. Aerospace & Defense misconfiguration across environments
2. Dependency outage affecting Aerospace & Defense
3. Missing monitoring on Aerospace & Defense critical path
