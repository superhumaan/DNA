# Troubleshooting — HR Tech

## Top failure modes
1. HR Tech misconfiguration across environments
2. Dependency outage affecting HR Tech
3. Missing monitoring on HR Tech critical path
