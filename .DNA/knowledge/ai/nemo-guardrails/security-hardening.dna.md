# Security hardening — NVIDIA NeMo Guardrails

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **NVIDIA NeMo Guardrails**.
