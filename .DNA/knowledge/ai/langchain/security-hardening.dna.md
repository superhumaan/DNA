# Security hardening — LangChain

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **LangChain**.

## Controls
- Tool allowlists
- No secrets in prompts logged
