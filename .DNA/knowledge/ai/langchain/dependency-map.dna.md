# Dependency map — LangChain

## Upstream
List services **LangChain** calls (DB, auth, payments, AI, queues). Note timeout and retry policy per dependency.

## Downstream
Who breaks if **LangChain** is down? (UI routes, jobs, webhooks, partner APIs)
