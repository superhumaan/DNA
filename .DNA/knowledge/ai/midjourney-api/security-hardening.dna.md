# Security hardening — Midjourney & Image APIs

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Midjourney & Image APIs**.
