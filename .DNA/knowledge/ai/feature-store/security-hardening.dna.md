# Security hardening — Feature Store Patterns

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Feature Store Patterns**.
