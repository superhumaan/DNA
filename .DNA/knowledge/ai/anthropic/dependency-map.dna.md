# Dependency map — Anthropic

## Upstream
List services **Anthropic** calls (DB, auth, payments, AI, queues). Note timeout and retry policy per dependency.

## Downstream
Who breaks if **Anthropic** is down? (UI routes, jobs, webhooks, partner APIs)
