# Security hardening — Anthropic

## Threat sketch
Attackers will try credential theft, injection, privilege escalation, and supply-chain abuse against **Anthropic**.

## Controls
- Server keys
- Allowlisted tools
- No silent prod mutations
