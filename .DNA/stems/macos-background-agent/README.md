...
Add or ship a macOS login-item agent that stays quiet, local, and separate from the menu-bar UI.

- **Stem ID:** `macos-background-agent`
- **Category:** delivery
- **Slash:** `/ macos-background-agent`
- **Catalog:** https://dna.humaan.app/intelligence#stem-macos-background-agent
