...
| **`stems/`** (**127 packs**) | Full prompt engineering library — guidelines, expectations, examples, workflows per stem (includes Expo/React Native) |
...
### 4. Prompt stem packs (127) + slash commands
...
| **DNA — one `doctor`** | **Yes** | **127 + rules** | **Yes** | **Yes** | **Yes** | **Yes** |
