...
8. Close: \`npx dna quality report --feature\` PASS → \`npx dna docker build\` → \`npx dna github push --message "[${identity.tag}] feat: <summary>"\` (trunk / current branch — no inventing feature remotes)
