...
export const DNA_AI_COMMAND_CATALOG: readonly DnaAiCommandDef[] = [
  ...
  },
  {
    ...
    category: "core",
    title: "DNA Agents",
    description: "Agent Mesh status, register, claim, heartbeat, and hook runner.",
    cli: "npx dna agents $ARGUMENTS",
    argumentHint: "status|register|claim|release|heartbeat|context|hook|install|commit",
    followUp: "Use claims before writing shared files. Isolated coding subagents are denied. Commit with `dna commit`.",
  },
  {
    id: "commit",
    category: "delivery",
    title: "DNA Commit",
    description: "Mutex commit of this agent's claimed/modified files only — never git add all.",
    cli: "npx dna commit",
    argumentHint: "[-m <message>]",
    followUp: "Verify `git status` is clean for this agent's files. Do not raw `git commit`.",
  },
  {
    id: "github-push",
    category: "delivery",
