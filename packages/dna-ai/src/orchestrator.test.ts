...
const sampleIssue: ClassifiedIssue = {
  ...
  confidence: 0.8,
  title: "Bad gateway from origin",
  summary: "HTTP 502 bad gateway — upstream origin returned an empty reply",
  suggestedFix: "Add health check endpoint for gateway probes",
  testRecommendation: "Assert /health returns 200",
