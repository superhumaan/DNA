...
# Behind edge auth: paste at /labs still works — pairing/init is optional
...
// Paste-verify: open /labs (app session if required), paste Pairing ID + code — init is optional.
