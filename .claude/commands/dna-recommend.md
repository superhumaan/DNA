...
# DNA Command: DNA Recommend

> Slash: `/dna-recommend` · Category: **Analysis**
...
Present the recommendation and tie it to `.DNA/knowledge/` packs to install.
...
**Then:** Present the recommendation and tie it to `.DNA/knowledge/` packs to install.
