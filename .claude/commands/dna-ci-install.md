...
# DNA Command: CI Install

> Slash: `/dna-ci-install` · Category: **Delivery**
...
List workflow files created under `.github/workflows/`.
...
**Then:** List workflow files created under `.github/workflows/`.
