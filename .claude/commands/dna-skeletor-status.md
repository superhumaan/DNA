...
# DNA Command: Skeletor Status

> Slash: `/dna-skeletor-status` · Category: **Core**
...
If installed, run `dna skeletor feed` and load `.DNA/CellularMemory/parietalLobe/skeletor-fleet.md` for cross-lab work.
...
**Then:** If installed, run `dna skeletor feed` and load `.DNA/CellularMemory/parietalLobe/skeletor-fleet.md` for cross-lab work.
