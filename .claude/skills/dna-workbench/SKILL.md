...
name: dna-workbench
description: >-
  DNA Workbench for dna-by-humaan — always-on default co-pilot in Claude Code.
...
- `.claude/skills/dna-workbench/dna-session-flow.md` — session types A–F
- `.claude/skills/dna-workbench/prompt-patterns.md` — how to prompt and verify
- - `CLAUDE.md` — always-on obedience (Claude Code)
- `.claude/skills/dna-cli/SKILL.md` — CLI routing and /dna-* commands
