...
Full detail: read `.claude/skills/dna-cli/commands-reference.md` or invoke any `/dna-*` slash command.
...
- `.claude/commands/dna-*.md` — per-command extreme detail (invoke with `/`)
